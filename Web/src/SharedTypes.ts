...
const typeMap: any = {
  ...
  Action: o(
    [
      { json: "reload", js: "reload", typ: u(undefined, r("ReloadAction")) },
      {
        json: "run_javascript",
        js: "runJavascript",
        typ: u(undefined, r("RunJavaScriptAction")),
      },
      {
        json: "tab_close",
        js: "tabClose",
        typ: u(undefined, r("TabCloseAction")),
      },
      {
        json: "tab_next",
        js: "tabNext",
        typ: u(undefined, r("TabNextAction")),
      },
      {
        json: "tab_previous",
        js: "tabPrevious",
        typ: u(undefined, r("TabPreviousAction")),
      },
    ],
    "any"
  ),
  ReloadAction: o([{ json: "action", js: "action", typ: true }], "any"),
  ...
  TabCloseAction: o([{ json: "action", js: "action", typ: true }], "any"),
  TabNextAction: o([{ json: "action", js: "action", typ: true }], "any"),
  TabPreviousAction: o([{ json: "action", js: "action", typ: true }], "any"),
  Pattern: o([{ json: "data", js: "data", typ: a(r("Vector")) }], "any"),
  Vector: o(
    [
